...
layui.define(['layer', 'form', 'code'], function (exports) {
    ...
    var setIframe = function (editor, textArea, set) {
                                ...
                                layui.use('upload', function () {
                                    ...
                                    upload.render({
                                        ...
                                        , done: function (res, index, upload) {
                                            if (res.code == 0) {                                                
                                                $('#imgsPrev img[data-index="' + index + '"]').attr('src', res.msg);
                                            } else {
                                                layer.msg(res.msg || '上传失败');
                                            }
        ...
        , tools = {
            ...
            ,
            image_alt: '<i class="layui-icon layedit-tool-image_alt" title="图片" layedit-event="images" style="font-size:18px">&#xe64a;</i>'
            ,
