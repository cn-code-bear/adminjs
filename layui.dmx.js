...
;!function(win){
  ...
  ,modules = {
	...
	,cascader: 'modules/cascader' //表单集
	,inputTags: 'modules/inputTags' //表单集
	,imgs: 'modules/imgs' //表单集
	,sortable: 'modules/sortable' //表单集
    ,upload: 'modules/upload' //上传
    ,transfer: 'modules/transfer' //上传
    ,tree: 'modules/tree' //树结构
	,treetable: 'modules/treetable' //树结构
  ...
  // 获取参数
  Layui.prototype.get = function(d=false){
    var that = this,
    data='',
    res={},
    hash = location.hash;
